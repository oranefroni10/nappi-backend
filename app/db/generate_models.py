#!/usr/bin/env python3
"""
Script to generate Pydantic models from database schema
Run this to regenerate models when the database schema changes
"""
import asyncio
import asyncpg
...
async def generate_pydantic_models():
    ...
    try:
        ...
        for table in tables:
            ...
            # Generate class name (convert snake_case to PascalCase)
